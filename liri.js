...
//----------------twitter-------------------------
//twitter function prints 20 tweets linked up to account in the keys.js file
...
function spotifyFunction() {
    ...
    if (process.argv.length > 2) {
        ...
        var spotifyQueryUrl = "https://api.spotify.com/v1/search?q=" + multiWordSong + "&type=track";
    ...
    fs.readFile("random.txt", "utf8", function (error, data) {
        ...
        for (var i = 0; i < dataArray.length; i++) {
            ...
            if (randomCommand === "spotify-this-song") {
                var queryUrl = "https://api.spotify.com/v1/search?q=" + randomSongSelected + "&type=track";
                request(queryUrl, function (error, response, body) {
